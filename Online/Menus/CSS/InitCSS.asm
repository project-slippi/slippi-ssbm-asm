...
.string "ggs           "
.set TPO_STRING_CHATMSG_UP_PAD_DOWN, TPO_STRING_CHATMSG_UP_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "One More      "
.set TPO_STRING_CHATMSG_UP_PAD_RIGHT, TPO_STRING_CHATMSG_UP_PAD_DOWN + CHAT_TEXT_STRING_LENGTH
.string "brb           "
.set TPO_STRING_CHATMSG_UP_PAD_LEFT, TPO_STRING_CHATMSG_UP_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "Back          "

.set TPO_STRING_CHATMSG_DOWN_PAD_UP, TPO_STRING_CHATMSG_UP_PAD_LEFT+CHAT_TEXT_STRING_LENGTH
.string "Bad Connection"
.set TPO_STRING_CHATMSG_DOWN_PAD_DOWN, TPO_STRING_CHATMSG_DOWN_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "Well Played   "
.set TPO_STRING_CHATMSG_DOWN_PAD_RIGHT, TPO_STRING_CHATMSG_DOWN_PAD_DOWN + CHAT_TEXT_STRING_LENGTH
.string "FT3           "
.set TPO_STRING_CHATMSG_DOWN_PAD_LEFT, TPO_STRING_CHATMSG_DOWN_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "FT5           "

.set TPO_STRING_CHATMSG_RIGHT_PAD_UP, TPO_STRING_CHATMSG_DOWN_PAD_LEFT+CHAT_TEXT_STRING_LENGTH
.string "Ok            "
.set TPO_STRING_CHATMSG_RIGHT_PAD_DOWN, TPO_STRING_CHATMSG_RIGHT_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "Nope          "
.set TPO_STRING_CHATMSG_RIGHT_PAD_RIGHT, TPO_STRING_CHATMSG_RIGHT_PAD_DOWN + CHAT_TEXT_STRING_LENGTH
.string "Sorry         "
.set TPO_STRING_CHATMSG_RIGHT_PAD_LEFT, TPO_STRING_CHATMSG_RIGHT_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "Thanks        "

.set TPO_STRING_CHATMSG_LEFT_PAD_UP, TPO_STRING_CHATMSG_RIGHT_PAD_LEFT+CHAT_TEXT_STRING_LENGTH
.string "Change Char   "
.set TPO_STRING_CHATMSG_LEFT_PAD_DOWN, TPO_STRING_CHATMSG_LEFT_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "Changing Char "
.set TPO_STRING_CHATMSG_LEFT_PAD_RIGHT, TPO_STRING_CHATMSG_LEFT_PAD_DOWN + CHAT_TEXT_STRING_LENGTH
.string "Please        "
.set TPO_STRING_CHATMSG_LEFT_PAD_LEFT, TPO_STRING_CHATMSG_LEFT_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "No problem    "

.set TPO_STRING_SPINNER_1, TPO_STRING_CHATMSG_LEFT_PAD_LEFT + CHAT_TEXT_STRING_LENGTH
.short 0x817B # ＋
.byte 0x00
