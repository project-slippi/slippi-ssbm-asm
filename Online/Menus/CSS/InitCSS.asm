...
# Registries to be used in Chat Messagees Think Function
.set CHAT_ENTITY_DATA_OFFSET, 0x2C # offset from GOBJ to entity data
.set REG_CHATMSG_GOBJ, 14
.set REG_CHATMSG_GOBJ_DATA_ADDR, 15
.set REG_CHATMSG_TIMER, 16
.set REG_CHATMSG_MSG_ID, 17
.set REG_CHATMSG_MSG_INDEX, 18
.set REG_CHATMSG_MSG_TEXT_STRUCT_ADDR, 19
.set REG_CHATMSG_MSG_STRING_ADDR, 20
.set REG_CHATMSG_USER_NAME_ADDR, 21
# float registers
.set REG_CHATMSG_TEXT_X_POS, 13
.set REG_CHATMSG_TEXT_Y_POS, 14

 # Chat Messages Pad Mapping
.set CHATMSG_LEFT_PAD_LEFT, 0x11
.set CHATMSG_LEFT_PAD_RIGHT, 0x12
.set CHATMSG_LEFT_PAD_DOWN, 0x14
.set CHATMSG_LEFT_PAD_UP, 0x18
.set CHATMSG_RIGHT_PAD_LEFT, 0x21
.set CHATMSG_RIGHT_PAD_RIGHT, 0x22
.set CHATMSG_RIGHT_PAD_DOWN, 0x24
.set CHATMSG_RIGHT_PAD_UP, 0x28
.set CHATMSG_DOWN_PAD_LEFT, 0x41
.set CHATMSG_DOWN_PAD_RIGHT, 0x42
.set CHATMSG_DOWN_PAD_DOWN, 0x44
.set CHATMSG_DOWN_PAD_UP, 0x48
.set CHATMSG_UP_PAD_LEFT, 0x81
.set CHATMSG_UP_PAD_RIGHT, 0x82
.set CHATMSG_UP_PAD_DOWN, 0x84
.set CHATMSG_UP_PAD_UP, 0x88

.set CHATMSG_OUTLINES, 2
...
.set TPO_STRING_CHATMSG_UP_PAD_UP, TPO_STRING_CHATMSG_FORMAT + 7
.string "ggs                   "
.set TPO_STRING_CHATMSG_UP_PAD_LEFT, TPO_STRING_CHATMSG_UP_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "one more              "
.set TPO_STRING_CHATMSG_UP_PAD_RIGHT, TPO_STRING_CHATMSG_UP_PAD_LEFT + CHAT_TEXT_STRING_LENGTH
.string "brb                   "
.set TPO_STRING_CHATMSG_UP_PAD_DOWN, TPO_STRING_CHATMSG_UP_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "good luck             "

.set TPO_STRING_CHATMSG_DOWN_PAD_UP, TPO_STRING_CHATMSG_UP_PAD_DOWN+CHAT_TEXT_STRING_LENGTH
.string "back                  "
.set TPO_STRING_CHATMSG_DOWN_PAD_LEFT, TPO_STRING_CHATMSG_DOWN_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "thinking              "
.set TPO_STRING_CHATMSG_DOWN_PAD_RIGHT, TPO_STRING_CHATMSG_DOWN_PAD_LEFT + CHAT_TEXT_STRING_LENGTH
.string "let's play again later"
.set TPO_STRING_CHATMSG_DOWN_PAD_DOWN, TPO_STRING_CHATMSG_DOWN_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "bad connection        "

.set TPO_STRING_CHATMSG_RIGHT_PAD_UP, TPO_STRING_CHATMSG_DOWN_PAD_DOWN+CHAT_TEXT_STRING_LENGTH
.string "lol                   "
.set TPO_STRING_CHATMSG_RIGHT_PAD_LEFT, TPO_STRING_CHATMSG_RIGHT_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "sorry                 "
.set TPO_STRING_CHATMSG_RIGHT_PAD_RIGHT, TPO_STRING_CHATMSG_RIGHT_PAD_LEFT + CHAT_TEXT_STRING_LENGTH
.string "oops                  "
.set TPO_STRING_CHATMSG_RIGHT_PAD_DOWN, TPO_STRING_CHATMSG_RIGHT_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "wow                   "

.set TPO_STRING_CHATMSG_LEFT_PAD_UP, TPO_STRING_CHATMSG_RIGHT_PAD_DOWN+CHAT_TEXT_STRING_LENGTH
.string "well played           "
.set TPO_STRING_CHATMSG_LEFT_PAD_LEFT, TPO_STRING_CHATMSG_LEFT_PAD_UP + CHAT_TEXT_STRING_LENGTH
.string "too good              "
.set TPO_STRING_CHATMSG_LEFT_PAD_RIGHT, TPO_STRING_CHATMSG_LEFT_PAD_LEFT + CHAT_TEXT_STRING_LENGTH
.string "that was fun          "
.set TPO_STRING_CHATMSG_LEFT_PAD_DOWN, TPO_STRING_CHATMSG_LEFT_PAD_RIGHT + CHAT_TEXT_STRING_LENGTH
.string "thanks                "

.set TPO_STRING_SPINNER_1, TPO_STRING_CHATMSG_LEFT_PAD_DOWN + CHAT_TEXT_STRING_LENGTH
.short 0x817B # ＋
.byte 0x00
...
# Set Chat message string to r5
# TODO: use hacky properties assignemnt same as HandleInputOnCss is doing it.
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_LEFT_PAD_LEFT
beq SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_LEFT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_LEFT_PAD_RIGHT
beq SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_RIGHT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_LEFT_PAD_DOWN
beq SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_DOWN
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_LEFT_PAD_UP
beq SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_UP

cmpwi REG_CHATMSG_MSG_ID, CHATMSG_RIGHT_PAD_LEFT
beq SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_LEFT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_RIGHT_PAD_RIGHT
beq SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_RIGHT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_RIGHT_PAD_DOWN
beq SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_DOWN
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_RIGHT_PAD_UP
beq SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_UP

cmpwi REG_CHATMSG_MSG_ID, CHATMSG_DOWN_PAD_LEFT
beq SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_LEFT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_DOWN_PAD_RIGHT
beq SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_RIGHT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_DOWN_PAD_DOWN
beq SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_DOWN
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_DOWN_PAD_UP
beq SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_UP

cmpwi REG_CHATMSG_MSG_ID, CHATMSG_UP_PAD_LEFT
beq SET_CHATMSG_STRING_CHATMSG_UP_PAD_LEFT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_UP_PAD_RIGHT
beq SET_CHATMSG_STRING_CHATMSG_UP_PAD_RIGHT
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_UP_PAD_DOWN
beq SET_CHATMSG_STRING_CHATMSG_UP_PAD_DOWN
cmpwi REG_CHATMSG_MSG_ID, CHATMSG_UP_PAD_UP
beq SET_CHATMSG_STRING_CHATMSG_UP_PAD_UP

addi r4, REG_TEXT_PROPERTIES, TPO_EMPTY_STRING # set empty string by default

SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_LEFT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_LEFT_PAD_LEFT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_RIGHT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_LEFT_PAD_RIGHT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_DOWN:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_LEFT_PAD_DOWN
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_LEFT_PAD_UP:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_LEFT_PAD_UP
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_LEFT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_RIGHT_PAD_LEFT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_RIGHT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_RIGHT_PAD_RIGHT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_DOWN:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_RIGHT_PAD_DOWN
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_RIGHT_PAD_UP:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_RIGHT_PAD_UP
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_LEFT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_DOWN_PAD_LEFT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_RIGHT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_DOWN_PAD_RIGHT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_DOWN:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_DOWN_PAD_DOWN
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_DOWN_PAD_UP:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_DOWN_PAD_UP
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_UP_PAD_LEFT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_UP_PAD_LEFT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_UP_PAD_RIGHT:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_UP_PAD_RIGHT
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_UP_PAD_DOWN:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_UP_PAD_DOWN
b SET_CHATMSG_TEXT_HEADER
SET_CHATMSG_STRING_CHATMSG_UP_PAD_UP:
addi r4, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_UP_PAD_UP
b SET_CHATMSG_TEXT_HEADER
...
li r25, 0 # subindex start
lfs f25, TPO_CHATMSG_OUTLINE_OFFSET(REG_TEXT_PROPERTIES) # load offset
CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_START:

# Get X+Y Position
fmr f1, REG_CHATMSG_TEXT_X_POS
fmr f2, REG_CHATMSG_TEXT_Y_POS

# Move X+Y positions if is an outline
cmpwi r25, 0 # left outline
beq CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_LEFT
cmpwi r25, 1 # right outline
beq CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_RIGHT
cmpwi r25, 2 # top outline
beq CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_TOP
#cmpwi r25, 3 # bottom outline
#beq CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_TOP
#beq CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_BOTTOM
b CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT

CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_LEFT:
fsubs f1,f1,f25 # shift left
b CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT
CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_RIGHT:
fadds f1,f1,f25  # shift right
b CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT
CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_TOP:
fsubs f2,f2,f25 # shift up
b CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT
CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SHIFT_OUTLINE_BOTTOM:
fadds f2,f2,f25  # shift down
b CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT

CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT:
# Initialize subtext
...
# Set Text Size
mr r4, r3 # SubText Index
mr r3, REG_CHATMSG_MSG_TEXT_STRUCT_ADDR # 8019600c
lfs f1, TPO_CHATMSG_SIZE(REG_TEXT_PROPERTIES)
lfs f2, TPO_CHATMSG_SIZE(REG_TEXT_PROPERTIES)

# If reached last index, set small y size
cmpwi r25, CHATMSG_OUTLINES
bne CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT_SCALE_SET
lfs f2, TPO_CHATMSG_SIZE_SM(REG_TEXT_PROPERTIES)

CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_INITIALIZE_SUBTEXT_SCALE_SET:
branchl r12, Text_UpdateSubtextSize

# Set Color to white only if SubText Index is 4
addi r5, REG_TEXT_PROPERTIES, TPO_COLOR_CHAT_BG # Black
cmpwi r25, CHATMSG_OUTLINES
bne CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SET_COLOR
addi r5, REG_TEXT_PROPERTIES, TPO_COLOR_CHAT # White

CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_SET_COLOR:
# Set Text Color
mr r3, REG_CHATMSG_MSG_TEXT_STRUCT_ADDR
mr r4, r25 # Subtext Index
branchl r12, Text_ChangeTextColor

# concatenate user name with message "User: Message"
mr r3, REG_CHATMSG_MSG_TEXT_STRUCT_ADDR
mr r4, r25 # Subtext Index
addi r5, REG_TEXT_PROPERTIES, TPO_STRING_CHATMSG_FORMAT
mr r6, REG_CHATMSG_USER_NAME_ADDR
mr r7, REG_CHATMSG_MSG_STRING_ADDR
branchl r12, Text_UpdateSubtextContents

# if reached last index, then end the loop, else increment and go back
cmpwi r25, CHATMSG_OUTLINES
beq CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_END

# Increment Index and start again
addi r25, r25, 1
b CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_START

CSS_ONLINE_CHAT_INITIALIZE_TEXT_LOOP_END:
...
################################################################################
# Update subtext function for use only by chat messsages think function
# Will set r3 to REG_CHATMSG_MSG_TEXT_STRUCT_ADDR. Expects caller to set other args
################################################################################
FN_UPDATE_CHAT_TEXT:
mflr REG_LR # Single depth helper function. Non-standard
