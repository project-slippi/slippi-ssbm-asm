...
# TODO: This can cause a flickering effect of 1 fram when the wrong costume or character is selected.
# TODO: For now this is fixed with PreventWrongCSPOnCharSelect
